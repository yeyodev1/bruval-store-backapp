...
const catalog: CatalogProduct[] = [
  { sku: "RP35", name: "Rosa preservada", collection: "Rosas preservadas", dimensions: "21 x 24 cm", price: 79, regularPrice: 99, discountPercentage: 20, description: "Detalles exclusivos que conservan la belleza de las flores por mucho tiempo. Producto contiene: Rosa preservada en talla Extra Large con tallo, hojas y musgo preservado.", imageFile: "033.png", palette: "Rojo" },
  { sku: "RP40", name: "Rosa preservada", collection: "Rosas preservadas", dimensions: "18 x 27 cm", price: 65, regularPrice: 110, discountPercentage: 41, description: "Detalles exclusivos que conservan la belleza de las flores por mucho tiempo. Producto contiene: Rosa preservada tamaño Extra Large decorado con Tallo, hojas y musgo preservado.", imageFile: "047.png", palette: "Rojo" },
  { sku: "RP45", name: "Rosas preservadas", collection: "Rosas preservadas", dimensions: "24 x 40 cm", price: 129, regularPrice: 179, discountPercentage: 28, description: "Detalles exclusivos que conservan la belleza de las flores por mucho tiempo. Producto contiene: 2 Rosas preservadas en talla Extra Large decoradas con tallos, hojas y musgo preservado", imageFile: "026.png", palette: "Rojo" },
  { sku: "RP50", name: "Rosa y girasol preservados", collection: "Rosas preservadas", dimensions: "21 x 24 cm", price: 89, regularPrice: 119, discountPercentage: 25, description: "Detalles exclusivos que conservan la belleza de las flores por mucho tiempo. Producto contiene Rosa preservada talla Extra Large, Girasol preservado talla Small decorado con tallos, hojas y musgo preservado.", imageFile: "035.png", palette: "Rojo" },
